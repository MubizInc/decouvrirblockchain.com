...
<head>
    <?php
        ...
        include_once(ROOT_PATH."/pages/9/head.php");
...
<body>
    ...
    <header class="intro-header" style="background-image: url('<?=ARTICLE_9_PICTURE?>')">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="post-heading">
                        <h1><?=ARTICLE_9_TITLE?></h1>
                        <h2 class="subheading"><?=ARTICLE_9_SUBTITLE?></h2>
                        <span class="meta">Publié par <a href="/about/"><?=ARTICLE_9_AUTHOR?></a> le <?=ARTICLE_9_PUBLISHED_DATE?></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <ul class="col-md-8 crumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="last" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemprop="item" title="<?=ARTICLE_9_TITLE?>">
                                <span itemprop="name"><?=ARTICLE_9_TITLE?></span>
                            </a>
