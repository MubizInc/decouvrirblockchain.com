...
<head>
    <?php
        ...
        include_once(ROOT_PATH."/pages/17/head.php");
...
<body>
    ...
    <header class="intro-header" style="background-image: url('<?=ARTICLE_17_PICTURE?>')">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="post-heading">
                        <h1><?=ARTICLE_17_TITLE?></h1>
                        <h2 class="subheading"><?=ARTICLE_17_SUBTITLE?></h2>
                        <span class="meta">Publié par <a href="/about/"><?=ARTICLE_17_AUTHOR?></a> le <?=ARTICLE_17_PUBLISHED_DATE?></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <ul class="col-md-8 crumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="last" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemprop="item" title="<?=ARTICLE_17_TITLE?>">
                                <span itemprop="name"><?=ARTICLE_17_TITLE?></span>
                            </a>
