...
<head>
    <?php
        ...
        include_once(ROOT_PATH."/pages/14/head.php");
...
<body>
    ...
    <header class="intro-header" style="background-image: url('<?=ARTICLE_14_PICTURE?>')">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="post-heading">
                        <h1><?=ARTICLE_14_TITLE?></h1>
                        <h2 class="subheading"><?=ARTICLE_14_SUBTITLE?></h2>
                        <span class="meta">Publié par <a href="/about/"><?=ARTICLE_14_AUTHOR?></a> le <?=ARTICLE_14_PUBLISHED_DATE?></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <ul class="col-md-8 crumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="last" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemprop="item" title="<?=ARTICLE_14_TITLE?>">
                                <span itemprop="name"><?=ARTICLE_14_TITLE?></span>
                            </a>
