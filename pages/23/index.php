...
<head>
    <?php
        ...
        include_once(ROOT_PATH."/pages/23/head.php");
...
<body>
    ...
    <header class="intro-header" style="background-image: url('<?=ARTICLE_23_PICTURE?>')">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="post-heading">
                        <h1><?=ARTICLE_23_TITLE?></h1>
                        <h2 class="subheading"><?=ARTICLE_23_SUBTITLE?></h2>
                        <span class="meta">Publié par <a href="/about/"><?=ARTICLE_23_AUTHOR?></a> le <?=ARTICLE_23_PUBLISHED_DATE?></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <ul class="col-md-8 crumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="last" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemprop="item" title="<?=ARTICLE_23_TITLE?>">
                                <span itemprop="name"><?=ARTICLE_23_TITLE?></span>
                            </a>
