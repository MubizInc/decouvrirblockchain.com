...
<head>
    <?php
        ...
        include_once(ROOT_PATH."/pages/10/head.php");
...
<body>
    ...
    <header class="intro-header" style="background-image: url('<?=ARTICLE_10_PICTURE?>')">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="post-heading">
                        <h1><?=ARTICLE_10_TITLE?></h1>
                        <h2 class="subheading"><?=ARTICLE_10_SUBTITLE?></h2>
                        <span class="meta">Publié par <a href="/about/"><?=ARTICLE_10_AUTHOR?></a> le <?=ARTICLE_10_PUBLISHED_DATE?></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <ul class="col-md-8 crumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="last" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemprop="item" title="<?=ARTICLE_10_TITLE?>">
                                <span itemprop="name"><?=ARTICLE_10_TITLE?></span>
                            </a>
