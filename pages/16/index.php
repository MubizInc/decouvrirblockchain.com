...
<head>
    <?php
        ...
        include_once(ROOT_PATH."/pages/16/head.php");
...
<body>
    ...
    <header class="intro-header" style="background-image: url('<?=ARTICLE_16_PICTURE?>')">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="post-heading">
                        <h1><?=ARTICLE_16_TITLE?></h1>
                        <h2 class="subheading"><?=ARTICLE_16_SUBTITLE?></h2>
                        <span class="meta">Publié par <a href="/about/"><?=ARTICLE_16_AUTHOR?></a> le <?=ARTICLE_16_PUBLISHED_DATE?></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <ul class="col-md-8 crumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="last" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemprop="item" title="<?=ARTICLE_16_TITLE?>">
                                <span itemprop="name"><?=ARTICLE_16_TITLE?></span>
                            </a>
