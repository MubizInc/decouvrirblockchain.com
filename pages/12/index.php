...
<head>
    <?php
        ...
        include_once(ROOT_PATH."/pages/12/head.php");
...
<body>
    ...
    <header class="intro-header" style="background-image: url('<?=ARTICLE_12_PICTURE?>')">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="post-heading">
                        <h1><?=ARTICLE_12_TITLE?></h1>
                        <h2 class="subheading"><?=ARTICLE_12_SUBTITLE?></h2>
                        <span class="meta">Publié par <a href="/about/"><?=ARTICLE_12_AUTHOR?></a> le <?=ARTICLE_12_PUBLISHED_DATE?></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <ul class="col-md-8 crumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="last" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemprop="item" title="<?=ARTICLE_12_TITLE?>">
                                <span itemprop="name"><?=ARTICLE_12_TITLE?></span>
                            </a>
